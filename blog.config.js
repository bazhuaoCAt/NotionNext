...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '八爪猫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '来自地球的软体纲猫科动物', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-9hmz.vercel.app/archive', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '八爪猫, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个作家, Hi，我是一个独立游戏开发者,Hi，我是一个干饭人,欢迎来到我的博客🎉',
